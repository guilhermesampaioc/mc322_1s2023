...
public class Seguradora {
	...
	public ArquivoClientePF arquivoClientePF;
	public ArquivoClientePJ arquivoClientePJ;
	public ArquivoFrota arquivoFrota;
	public ArquivoSeguro arquivoSeguro;
	public ArquivoVeiculo arquivoVeiculo;
	public ArquivoSinistro arquivoSinistro;
	public ArquivoCondutor arquivoCondutor;
	...
	public ClientePJ lerClientePJ() {
		...
		System.out.println("Qual o telefone desse cliente?");
		...
		ClientePJ c_1 = new ClientePJ(nome, endereco, telefone, cnpj, dataFundacao, tipoCliente, this.nome);
					
		return c_1;
	}
	
	public void lerDados(String nome_arquivo) throws EOFException {
		if (nome_arquivo.equals("clientesPF.csv")) {
		    File file = new File("/home/guilhermesampaioc/Downloads/clientesPF.csv");
		    this.arquivoClientePF = new ArquivoClientePF();
		    this.arquivoClientePF.lerArquivo(file, this.lista_clientes, this.lista_seguros);
		    for (int i = 0; i < lista_clientes.size(); i++) {
		        SeguroPF seguropf = gerarSeguroPF((ClientePF)lista_clientes.get(i));
		        this.lista_seguros.add(seguropf);
		    }
		} else if (nome_arquivo.equals("clientesPJ.csv")) {
		    File file = new File("/home/guilhermesampaioc/Downloads/clientesPJ.csv");
		    this.arquivoClientePJ = new ArquivoClientePJ();
		    this.arquivoClientePJ.lerArquivo(file, this.lista_clientes, this.lista_seguros);
		    for (int i = 0; i < lista_clientes.size(); i++) {
		    	SeguroPJ seguropj = gerarSeguroPJ((ClientePJ)lista_clientes.get(i));
	      		this.lista_seguros.add(seguropj);
	      	}
		} else if (nome_arquivo.equals("condutores.csv")) {
		        		File file = new File("/home/guilhermesampaioc/Downloads/condutores.csv");
		        		this.arquivoCondutor = new ArquivoCondutor();
		        		this.arquivoCondutor.lerArquivo(file, this.lista_clientes, this.lista_seguros);
		} else if (nome_arquivo.equals("frotas.csv")) {
		        		File file = new File("/home/guilhermesampaioc/Downloads/frotas.csv");
		        		this.arquivoCondutor = new ArquivoCondutor();
		        		this.arquivoCondutor.lerArquivo(file, this.lista_clientes, this.lista_seguros);
		} else if (nome_arquivo.equals("veiculos.csv")) {
		        		File file = new File("/home/guilhermesampaioc/Downloads/veiculos.csv");
		        		this.arquivoCondutor = new ArquivoCondutor();
		        		this.arquivoCondutor.lerArquivo(file, this.lista_clientes, this.lista_seguros);
		        	}
	}
	
	public void gravarDados(String nome_arquivo) {
		
		if (nome_arquivo.equals("seguros.csv")) {
			this.arquivoSeguro = new ArquivoSeguro();
			this.arquivoSeguro.gravarArquivo(lista_seguros);
			
		} else if (nome_arquivo.equals("sinistros.csv")) {
			this.arquivoSinistro = new ArquivoSinistro();
			this.arquivoSinistro.gravarArquivo(lista_seguros);
		}
	}
