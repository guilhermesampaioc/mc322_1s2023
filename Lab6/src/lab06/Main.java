...
public class Main {
	...
	public static void main(String[] args) throws IOException, ParseException {
		...
		// leitura dos arquivos passados
		s_1.lerDados("clientesPF.csv");
		s_1.lerDados("clientesPJ.csv");
		s_1.lerDados("condutores.csv");
		s_1.lerDados("frotas.csv");
		
		// gravação dos arquivos com os dados dos seguros e sinistros
		
		s_1.gravarDados("seguros.csv");
		s_1.gravarDados("sinistros.csv");
