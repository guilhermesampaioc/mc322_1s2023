...
public class SeguroPJ extends Seguro {
	...
	public SeguroPJ(LocalDate dateInicio, LocalDate dateFim, Seguradora seguradora, Frota frota, ClientePJ cliente) {
	...
	public int calcularValor() {
		...
		Period idade0 = Period.between(cliente.getDataFundacao(), dataAtual);
		int idade = idade0.getYears();
		int valorMensal = (int) (CalcSeguro.VALOR_BASE.getOperacao() * (10 + (this.seguradora.qntFunc()))
				* (1 + (1/(this.frota.lista_veiculos.size() +2))) * (1 + (1/idade + 2)));
		return valorMensal;
	}
	...
	public Sinistro gerarSinistro(Seguro seguro) {	
		...
		public String toString() {
			return "O seguro foi cadastrado no dia " + this.dateInicio + " na seguradora " + this.seguradora.getNome() + 
					", tem vigência até o dia " + this.dateFim + ", para o cliente " + this.cliente.getNome() + "e "
							+ "na frota " + this.frota.getCode() + ".\n";
		}
